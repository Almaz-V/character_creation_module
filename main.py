...
def attack(char_name: str, char_class: str) -> str:
    """Данная функция отвечает за нанесение урона противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Данная функция отвечает за блокировку удара."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Данная функция отвечает за применение специальных умений."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Данная функция позволяет игроку выбрать персонажа."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    """Основная функция приветствия игрока и запуска программы."""
    run_screensaver()
